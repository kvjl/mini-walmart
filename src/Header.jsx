...
const Header = () => {
  return (
    <header>
      <nav
        className="flex w-full h-16 text-white items-center"
        style={{ backgroundColor: "#1a7fe0" }}
      >
        <div className="ml-4">
          <img
        ...
        <div className="flex justify-center flex-1">
          <div className="w-full max-w-2xl">
            <input
              type="text"
              placeholder="Search..."
              className="w-full px-4 py-2 bg-white text-black rounded-full focus:outline-none focus:ring-2 focus:ring-yellow-400"
            />
          </div>
        </div>
